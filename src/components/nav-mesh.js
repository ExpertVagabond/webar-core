/**
 * NavMesh — raycasting-based navigation constraint for A-Frame entities.
 * Extracted from 8thwall-archive/image-target-portal. Zero SDK dependency.
 *
 * Uses an 8-direction scan pattern to keep characters on walkable surfaces.
 * Includes gravity simulation and world-to-local coordinate conversion.
 *
 * Usage (A-Frame):
 *   <a-entity nav-mesh="navmesh: .walkable; fall: 0.5; height: 1.6"></a-entity>
 */
